...
.OZ24-entries-page-variation-1 .card-redesign {
    background: white;
...
.OZ24-entries-page-variation-1 .header-redesign {
...
.OZ24-entries-page-variation-1 .header-content-redesign {
    text-align: left !important;
    text-shadow: none !important;
    color: inherit !important
}

.OZ24-entries-page-variation-1 .entry-count-redesign {
...
.OZ24-entries-page-variation-1 .strike-price-redesign {
...
.OZ24-entries-page-variation-1 .main-price-redesign {
    color: #0d9488 !important;
    text-shadow: none !important;
    text-align: left !important
}

.OZ24-entries-page-variation-1 .price-container-redesign {
    justify-content: flex-start !important;
    align-items: baseline !important;
    text-align: left !important
}

.OZ24-entries-page-variation-1 .price-container-redesign~.mx-auto {
    text-align: left !important;
    margin-left: 0px !important
}

.OZ24-entries-page-variation-1 .price-container-redesign~.mx-auto .leading-none {
    overflow: unset !important
}

.OZ24-entries-page-variation-1 .price-container-redesign~.mx-auto .leading-none:focus-visible {
    background-color: #FFDD00 !important
}

.OZ24-entries-page-variation-1 .month-text-redesign {
...
.OZ24-entries-page-variation-1 .month-text-redesign+span.text-white {
...
.OZ24-entries-page-variation-1 .hide-discount-badge {
    display: none !important
}

.OZ24-entries-page-variation-1 .badge-container-redesign {
...
.OZ24-entries-page-variation-1 .badge-redesign {
...
.OZ24-entries-page-variation-1 .badge-redesign.bg-\[#0193A7\],
.OZ24-entries-page-variation-1 .badge-redesign.rounded-b-2xl,
.OZ24-entries-page-variation-1 .badge-redesign.shadow-lg {
    background: none !important;
    border-radius: 0 !important;
    box-shadow: none !important
}

.OZ24-entries-page-variation-1 .badge-redesign span {
    font-size: 0 !important;
    position: relative !important;
    z-index: 2 !important
}

.OZ24-entries-page-variation-1 .badge-gray {
    background-color: #626262 !important;
    border-bottom-left-radius: 2rem !important
}

.OZ24-entries-page-variation-1 .badge-gray::after {
...
.OZ24-entries-page-variation-1 .badge-teal {
    background-color: #0090B1 !important;
    border-bottom-left-radius: 2rem !important
}

.OZ24-entries-page-variation-1 .badge-teal::after {
...
.OZ24-entries-page-variation-1 .badge-dark {
    background-color: #081F28 !important;
    border-bottom-left-radius: 2rem !important
}

.OZ24-entries-page-variation-1 .badge-dark::after {
    content: "Two Bonus Draws Included" !important;
    position: absolute !important;
    top: 50% !important;
    left: 50% !important;
...
.OZ24-entries-page-variation-1 .body-redesign {
    padding: 1rem;
...
.OZ24-entries-page-variation-1 .feature-item-redesign {
    display: flex;
...
.OZ24-entries-page-variation-1 .feature-item-redesign span {
    padding-left: 0.5rem !important;
    padding-bottom: 0 !important;
    line-height: 1.4 !important
}

.OZ24-entries-page-variation-1 .feature-icon-redesign {
    width: 1.5rem;
    height: 1.5rem;
    border-radius: 50%;
    display: flex;
...
.OZ24-entries-page-variation-1 .feature-icon-redesign+span {
    padding-left: 0px !important
}

.OZ24-entries-page-variation-1 .checkmark-icon {
...
.OZ24-entries-page-variation-1 .entries-icon {
...
.OZ24-entries-page-variation-1 .price-icon {
...
.OZ24-entries-page-variation-1 .bonus-box-redesign {
    display: flex !important;
...
.OZ24-entries-page-variation-1 .bonus-box-redesign .flex.w-6 {
    font-size: 0 !important;
    color: transparent !important
}

.OZ24-entries-page-variation-1 .bonus-box-gift .flex.w-6 {
...
.OZ24-entries-page-variation-1 .bonus-box-money .flex.w-6 {
...
.OZ24-entries-page-variation-1 a[id*="add-to-cart"] {
    padding-top: 25px !important
}

.OZ24-entries-page-variation-1 a[id*="add-to-cart"] [data-entries-amount="200"] {
    background-color: #FFDD00 !important;
    border: none !important
}

.OZ24-entries-page-variation-1 a[id*="add-to-cart"] [data-entries-amount="200"]:hover {
    background-color: #FDEE8C !important
}

.OZ24-entries-page-variation-1 a[id*="add-to-cart"] button {
    border: 1px solid #3B5C6B;
    background-color: transparent !important
}

.OZ24-entries-page-variation-1 a[id*="add-to-cart"] button:hover,
.OZ24-entries-page-variation-1 a[id*="add-to-cart"] button:focus,
.OZ24-entries-page-variation-1 a[id*="add-to-cart"] button:active,
.OZ24-entries-page-variation-1 a[id*="add-to-cart"] button:focus-visible {
    background-color: white !important
}

.OZ24-entries-page-variation-1 .button-redesign {
    width: 100% !important;
...
.OZ24-entries-page-variation-1 .body-redesign>.block:last-child {
