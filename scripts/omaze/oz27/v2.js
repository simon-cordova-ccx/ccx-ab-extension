...
const createSlideshowElement = () => {
  ...
  SLIDE_DATA.forEach((data, index) => {
    ...
    const trustPilotElement = document.createElement('div');
    trustPilotElement.classList.add('trustpilot-widget');
    const trustPilotImage = document.createElement('img');
    trustPilotImage.src = 'https://cdn.shopify.com/s/files/1/0275/8390/5878/files/trustpilot_stars_4.8_150x30.png?v=1701267763';
    trustPilotImage.alt = 'Trustpilot rating 4.8 out of 5 stars';
    trustPilotImage.style.height = '16px';
    trustPilotImage.style.marginLeft = '8px';
    trustPilotElement.appendChild(trustPilotImage);
