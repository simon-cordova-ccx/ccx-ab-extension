...
const SELECTOR_NAVIGATION_BAR = '#main-nav';
...
const waitForElements = (elementSelector) => {
  ...
  DYO.waitForElementAsync(elementSelector, 1, 100, 150)
    .then(function (elements) {
      // Element is ready and exists exactly once
    ...
    .catch(function () {
      // Element not found within 15 seconds
      console.warn('#main-nav not found within timeout.');
    });
...
async function init() {
  try {
    ...
    waitForElements(SELECTOR_NAVIGATION_BAR);
